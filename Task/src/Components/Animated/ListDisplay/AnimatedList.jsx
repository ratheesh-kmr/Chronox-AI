    ...
    <div className={`relative w-full max-w-[600px] ${className}`}>
      <div
        ...
        className={`max-h-[500px] overflow-y-auto p-4 rounded-lg ${
          displayScrollbar
            ? "[&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-track]:bg-[#060010] [&::-webkit-scrollbar-thumb]:bg-[#333] [&::-webkit-scrollbar-thumb]:rounded-[4px]"
            : "scrollbar-hide"
        }`}
          ...
          >
            <div
              className={`rounded-lg transition-transform duration-200 ${
                selectedIndex === index ? "bg-[#1a1a1a]" : "bg-[#111]"
              } ${itemClassName}`}
            >
              {renderItem ? renderItem(item, index) : (
                <p className="text-white p-4 m-0">{item}</p>
              )}
            </div>
          </AnimatedItem>
        ))}
